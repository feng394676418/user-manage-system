...
export default {
    ...
    order: {
        ...
        Modelinfo: '产品型号',
        IMEI: 'IMEI号码',
        lengthdigits: 'IMEI长度必须为15位',
        purenumber: 'IMEI必须为纯数字',
        Formatsinclude: '上传图片大小不得超过5Mb，支持JPEG、PNG、GIF。最多上传三张。',
        Servicesrequired: '保修类型不能为空',
        WarrantyDate: '保修期限',
        TypeServices: '保修类型',
        enterTypeServices: '请选择保修类型',
        repairNameArray: [
    ...
    WarrantyPayment: {
        ...
        ReceivedPoint: '网点已收件',
        Showinformation: '展示详细信息',
        Foldinformation: '收起详细信息',
        notrepair: '放弃维修',

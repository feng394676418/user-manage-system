<template>
    <div class="container">
        ...
        <div class="main_content main_form_input">
            ...
            <AgreeOfferButtonChild></AgreeOfferButtonChild>
        </div>
    </div>
</template>
...
export default {
    components: { logintop, step, WorkOrderTable, UserInfo, TestReportTable, reason, CustomerShipping, AgreeOfferButtonChild },
    data () {
        return {
        }
    },

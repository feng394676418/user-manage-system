<template>
    <div>
        ...
        <el-dialog title="" :visible.sync="dialogVisible" size="tiny">
            ...
            <span slot="footer" class="dialog-footer">
                <el-button ref="btnsubmit_no" @click="dialogVisible = false" :plain="true" type="info" class="form-group">NO</el-button>
                <el-button ref="btnsubmit_yes" type="info" class="form-group" @click="repair(true)">YES</el-button>
            </span>
        </el-dialog>
    </div>
</template>
